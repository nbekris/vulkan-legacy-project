...
void key_cb(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ...
    else if (pressed && key == GLFW_KEY_R)
        app->VK->useRaytracer = !app->VK->useRaytracer;

    else if (pressed && key == GLFW_KEY_G)
        app->VK->show_gui = !app->VK->show_gui;

    else if (pressed && key == GLFW_KEY_V)
        app->myCamera.viewParms();
}
